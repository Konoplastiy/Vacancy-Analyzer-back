...
@Schema(name = "VacancyResponse", description = "Schema to hold vacancy response information")
public class VacancyDto {
  ...
  @Schema(
      ...
      example = "Join our team as a Software Engineer!")
  private String shortDescription;

  @NotBlank(message = "Url vacancy must not be blank")
  @Schema(
      description = "URL link to the vacancy",
